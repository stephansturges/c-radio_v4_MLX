...
existing INT8 TensorOps GEMM. The current C-RADIOv4 p99.99 Cider bundles are
per-channel W8A8, so the runtime hook only needs this op for the tested path.
