...
# C-RADIOv4-SO400M MLX Cider W8A8 p99.99

Fast experimental Apple M5+ W8A8 runtime bundle for `nvidia/C-RADIOv4-SO400M`.
...
- Local bundle path: `bundles/c-radiov4-so400m-cider-w8a8-p9999`
...
| --- | ---: | ---: |
| Smoke image | 0.998565 | 0.998815 |
| 12 WALDO crops mean/min | 0.998638 / 0.998112 | 0.999240 / 0.998586 |
...
| ---: | ---: | ---: | ---: |
| 256x256 | 1 | 10.7 ms | 93.5 images/s |
| 256x256 | 4 | 24.8 ms | 161.4 images/s |
| 512x512 | 1 | 29.8 ms | 33.5 images/s |
| 512x512 | 4 | 106.4 ms | 37.6 images/s |

This is the fastest tested SO400M Cider variant, but it trades away more embedding
precision than g128. Validate downstream metrics before using it as a default.
